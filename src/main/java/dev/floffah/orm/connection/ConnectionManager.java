...
public class ConnectionManager {
    ...
    List<ORMConnection> connections = new ArrayList<>();
    ...
    public void logQuery(String message) {
        log("&bQUERY &7" + message);
    }

    public void logTransaction(UUID transaction) {
        log("&bTRANSACTION &9" + transaction);
    }
    ...
    public void logCommit(UUID transaction) {
        log("&bCOMMIT &9" + transaction);
    }

    public void logCommit(String transaction) {
        log("&bCOMMIT &9" + transaction);
    }
    ...
    public void connectAll() throws SQLException {
        ...
        log("&aAll ConnectionFactories connected");
    }
}
